...
//    }
    ...
    public static JSONObject getAcess_TokenAndOpenId(String code){
        String url_token = "https://api.weixin.qq.com/sns/oauth2/access_token?appid=wxf1d651afc2118a6e&secret=667478093e89d5aab5e4b4e6fbc2a010&code=" + code + "&grant_type=authorization_code";
...
//    }
    public static String getSimpleAccess(){
        String url ="https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=wxf1d651afc2118a6e&secret=667478093e89d5aab5e4b4e6fbc2a010";
        JSONObject json = WechatUtil.getInfo(url);
